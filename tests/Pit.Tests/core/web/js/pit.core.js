...
Pit.FSharp.Collections.FSharpSet1 = (function() {
    function FSharpSet1(comparer, tree) {
        ...
        var thisObject = this;
        thisObject.comparer = comparer;
        thisObject.tree = tree;
    }
                    ...
                    try {
                        ...
                        return (function(thisObject) {
                            try {
                                        ...
                                        return (function(thisObject) {
                                            if (m1 == m2) {
                                                return (function(thisObject) {
                                                    if (!m1) {
                                                        return true;
                                                    } else if (e1.IEnumerator1_get_Current() == e2.IEnumerator1_get_Current()) {
                                                        return loop();
                                                    } else {
                                                        return false;
                                                    }
                                ...
                                (function(thisObject) {
                                    if (Pit.JsCommon.containsInterface(e2, "__getIDisposable")) {
                        ...
                        (function(thisObject) {
                            if (Pit.JsCommon.containsInterface(e1, "__getIDisposable")) {
    ...
    FSharpSet1.prototype.GetHashCode = (function() {
        var thisObject = this;
        return thisObject.ComputeHashCode();
    });
    FSharpSet1.prototype.ComputeHashCode = function() {
        ...
        var res = 0;
        var enumerator = thisObject.IEnumerable1_GetEnumerator();
        (function(thisObject) {
            try {
    ...
    FSharpSet1.prototype.ToArray = (function() {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.toArray(thisObject.get_Tree());
    });
    FSharpSet1.prototype.ToList = (function() {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.toList(thisObject.get_Tree());
    });
    FSharpSet1.prototype.IsProperSupersetOf = (function(y) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.psubset(thisObject.get_Comparer())(y.get_Tree())(thisObject.get_Tree());
    });
    FSharpSet1.prototype.IsProperSubsetOf = (function(y) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.psubset(thisObject.get_Comparer())(thisObject.get_Tree())(y.get_Tree());
    });
    FSharpSet1.prototype.IsSupersetOf = (function(y) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.subset(thisObject.get_Comparer())(y.get_Tree())(thisObject.get_Tree());
    });
    FSharpSet1.prototype.IsSubsetOf = (function(y) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.subset(thisObject.get_Comparer())(thisObject.get_Tree())(y.get_Tree());
    });
    FSharpSet1.prototype.GetPreviousElement = (function(e) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.prevElem(thisObject.get_Comparer())(e)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.GetNextElement = (function(e) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.nextElem(thisObject.get_Comparer())(e)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.ForAll = (function(f) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.forall(f)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.Exists = (function(f) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.exists(f)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.Add = function(x) {
        var thisObject = this;
        return new Pit.FSharp.Collections.FSharpSet1(thisObject.get_Comparer(), Pit.FSharp.Collections.SetTreeModule.add(thisObject.get_Comparer())(x)(thisObject.get_Tree()));
    };
    FSharpSet1.prototype.Remove = function(x) {
        var thisObject = this;
        return new Pit.FSharp.Collections.FSharpSet1(thisObject.get_Comparer(), Pit.FSharp.Collections.SetTreeModule.remove(thisObject.get_Comparer())(x)(thisObject.get_Tree()));
    };
    FSharpSet1.prototype.Contains = (function(x) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.mem(thisObject.get_Comparer())(x)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.Iterate = (function(x) {
        var thisObject = this;
        return Pit.FSharp.Collections.SetTreeModule.iter(x)(thisObject.get_Tree());
    });
    FSharpSet1.prototype.Fold = function(f) {
        ...
        return (function(z) {
            ...
            })(z)(thisObject.get_Tree());
        });
    };
    FSharpSet1.prototype.Partition = function(f) {
        var thisObject = this;
        var matchValue = thisObject.get_Tree();
        return (function(thisObject) {
    ...
    FSharpSet1.prototype.Map = function(f) {
        ...
        })(new Pit.FSharp.Collections.SetTree1.SetEmpty())(thisObject.get_Tree()));
    };
...
Pit.FSharp.Collections.ListEnumerator1 = (function() {
    function ListEnumerator1(s) {
        ...
        var thisObject = this;
        thisObject.s = s;
        thisObject.curr = thisObject.s;
        thisObject.started = false;
    }
...
Pit.Text.StringBuilder = (function() {
    ...
    StringBuilder.prototype.Append = (function(s) {
        var thisObject = this;
        return thisObject.array.push(s);
    });
    StringBuilder.prototype.toString = (function() {
        var thisObject = this;
        return thisObject.array.join('');
    });
...
Pit.FSharp.Control.EventPublish22 = (function() {
    function EventPublish22(eventFuncs) {
        ...
        var thisObject = this;
        thisObject.eventFuncs = eventFuncs;
    }
...
Pit.FSharp.Control.FSharpEvent2 = (function() {
    function FSharpEvent2() {
        var thisObject = this;
        thisObject.eventFuncs = [];
    }
    FSharpEvent2.prototype.Trigger = function(sender, args) {
        var thisObject = this;
        for (var i = 0; i <= (thisObject.eventFuncs.length - 1); i++) {
...
Pit.FSharp.Control.ObservableModule.BasicObserver1 = (function() {
    function BasicObserver1(next, error, completed) {
        ...
        var thisObject = this;
        thisObject.next = next;
        thisObject.error = error;
        thisObject.completed = completed;
        thisObject.stopped = false;
    }
        ...
        var check = function(i) {
                return (function(thisObject) {
                    if (i >= str1.get_Length()) {
                        return true;
                    } else if (f(Pit.FSharp.Core.LanguagePrimitives.IntrinsicFunctions.GetString(str1)(i))) {
                        return check((i + 1));
                    } else {
                        return false;
                    }
...
Pit.FSharp.Collections.SeqModule.IsEmpty = function(source) {
    ...
    return (function(thisObject) {
        try {
            ...
            (function(thisObject) {
                if (Pit.JsCommon.containsInterface(ie, "__getIDisposable")) {
...
Pit.FSharp.Core.CompilerServices.RuntimeHelpers.FinallyEnumerable1 = (function() {
    function FinallyEnumerable1(compensation, restf) {
        ...
        this.IEnumerable1 = __createIEnumerable1(this);
        var thisObject = this;
        thisObject.compensation = compensation;
        thisObject.restf = restf;
    }
    function __createIEnumerable(thisObject) {
        var ienumerable = (function() {
            function IEnumerable(thisObject) {
            ...
            IEnumerable1.prototype.GetEnumerator = function() {
                return (function(thisObject) {
                    try {
                        ...
                        return (function(thisObject) {
                            if (Pit.JsCommon.containsInterface(ie, "__getIFinallyEnumerator")) {
                                var a = ie;
...
Pit.FSharp.Core.CompilerServices.RuntimeHelpers.ConcatEnumerator2 = (function() {
    function ConcatEnumerator2(sources) {
        ...
        var thisObject = this;
        thisObject.outerEnum = sources.IEnumerable1_GetEnumerator();
        thisObject.currInnerEnum = Pit.FSharp.Collections.IEnumerator.Empty();
        thisObject.started = false;
    ...
    ConcatEnumerator2.prototype.GetCurrent = function() {
        var thisObject = this;
        Pit.FSharp.Collections.IEnumerator.check(thisObject.started);
        return (function(thisObject) {
...
Pit.FSharp.Core.CompilerServices.RuntimeHelpers.EnumerateWhileType1 = (function() {
    ...
    EnumerateWhileType1.prototype.finish = (function() {
        var thisObject = this;
        return thisObject.curr = new Pit.FSharp.Core.FSharpOption1.None();
    });
    ...
    return function(moveNext) {
        return (function(current) {
            return Pit.FSharp.Core.CompilerServices.RuntimeHelpers.Generate(opener)(function(x) {
                ...
                var matchValue = x;
                return (function(thisObject) {
                    if (Pit.JsCommon.containsInterface(matchValue, "__getIDisposable")) {
                        var id = matchValue;
...
Pit.FSharp.Collections.Generator.BaseGenerator1 = (function() {
    function BaseGenerator1(apply, disposer) {
        ...
        var thisObject = this;
        thisObject.apply = apply;
        thisObject.disposer = disposer;
    }
...
Pit.FSharp.Collections.Generator.appG = function(g) {
    ...
    return (function(thisObject) {
        if (res instanceof Pit.FSharp.Collections.Generator.Step1.Yield) {
            return res;
        } else if (res instanceof Pit.FSharp.Collections.Generator.Step1.Stop) {
...
Pit.FSharp.Collections.IEnumerator.SeqEnumerator1 = (function() {
    function SeqEnumerator1(m, d) {
        ...
        thisObject.m = m;
        thisObject.d = d;
        thisObject.state = new Pit.FSharp.Collections.IEnumerator.EnumeratorState.NotStarted();
    }
    SeqEnumerator1.prototype.GetCurrent = function() {
        var thisObject = this;
        var matchValue = thisObject.state;
        (function(thisObject) {
            if (matchValue instanceof Pit.FSharp.Collections.IEnumerator.EnumeratorState.Finished) {
                return Pit.FSharp.Collections.IEnumerator.alreadyFinished();
            } else if (matchValue instanceof Pit.FSharp.Collections.IEnumerator.EnumeratorState.InProcess) {
                return null;
            } else {
                return Pit.FSharp.Collections.IEnumerator.notStarted();
            }
        })(thisObject);
        return thisObject.curr;
    };
...
Pit.FSharp.Collections.IEnumerator.ArrayEnumerator1 = (function() {
    function ArrayEnumerator1(arr) {
        ...
        thisObject.arr = arr;
        thisObject.curr = -1;
        thisObject.len = thisObject.arr.get_Length();
    }
...
Pit.FSharp.Collections.IEnumerator.UptoEnumerator1 = (function() {
    function UptoEnumerator1(lastOption, f) {
        ...
        var thisObject = this;
        thisObject.f = f;
        thisObject.unstarted = -1;
        thisObject.completed = -2;
        var unreachable = -3;
        thisObject.finalIndex = (function(thisObject) {
        ...
        thisObject.index = thisObject.unstarted;
        thisObject.current = null;
    }
    UptoEnumerator1.prototype.setIndex = function(i) {
        var thisObject = this;
        thisObject.index = i;
        return thisObject.current = null;
    };
    UptoEnumerator1.prototype.getCurrent = function() {
        ...
        var matchValue = thisObject.current;
        (function(thisObject) {
            if (matchValue == null) {
        ...
        return Pit.FSharp.Control.LazyExtensions.Force(thisObject.current);
    };
            ...
            IEnumerator.prototype.MoveNext = function() {
                return (function(thisObject) {
                    if (thisObject.x.index == thisObject.x.completed) {
                        return false;
                    } else if (thisObject.x.index == thisObject.x.unstarted) {
...
Pit.FSharp.Collections.IEnumerator.WhileSomeEnumerator1 = (function() {
    function WhileSomeEnumerator1(openf, compute, closef) {
        ...
        this.IEnumerator1 = __createIEnumerator1(this);
        var thisObject = this;
        thisObject.compute = compute;
        thisObject.closef = closef;
        thisObject.started = false;
        thisObject.curr = new Pit.FSharp.Core.FSharpOption1.None();
        thisObject.state = new Pit.FSharp.Core.FSharpOption1.Some(openf());
    }
    ...
    WhileSomeEnumerator1.prototype.dispose = (function() {
        ...
        })(thisObject))((function(option) {
            return Pit.FSharp.Core.OptionModule.Iterate(thisObject.closef)(option);
        }));
    });
    ...
    return function(xs1) {
        return function(xs2) {
            ...
            return (function(thisObject) {
                ...
                } else if (matchValue.Item2 instanceof Pit.FSharp.Collections.FSharpList1.Empty) {
                    return cons;
                } else {
                    throw Pit.InvalidOperationException.ctors[0]("Lists have different lengths")
                }
                        ...
                        return (function(thisObject) {
                            if (matchValue.Item2 instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
                                ...
                                return (function(thisObject) {
                                        ...
                                        return (function(thisObject) {
                                            if (matchValue1.Item1.get_Item2() instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
                                                return (function(thisObject) {
                                                    ...
                                                    } else if (matchValue1.Item2 instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
                                                        return (function(thisObject) {
                                                            if (matchValue1.Item2.get_Item2() instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
                                                                return (function(thisObject) {
                                    ...
                                    } else if (matchValue1.Item2 instanceof Pit.FSharp.Collections.FSharpList1.Empty) {
                                        return f(h1)(k1)(acc);
                                    } else {
                                        return Pit.FSharp.Collections.ListModule.foldBack2UsingArrays(f)(list1)(list2)(acc);
                                    }
...
Pit.FSharp.Collections.SetTreeModule.SetTreeEnumerator1 = (function() {
    function SetTreeEnumerator1(s) {
        ...
        var thisObject = this;
        thisObject.s = s;
        thisObject.i = Pit.FSharp.Collections.SetTreeModule.mkIterator(thisObject.s);
    }
    function __createIDisposable(thisObject) {
        var idisposable = (function() {
            function IDisposable(thisObject) {
...
Pit.FSharp.Collections.SetTreeModule.toListLoop = function(m) {
    return function(acc) {
        return (function(thisObject) {
            ...
            } else if (m instanceof Pit.FSharp.Collections.SetTree1.SetEmpty) {
                return acc;
            } else {
                var r = m.get_Item3();
                var l = m.get_Item2();
...
Pit.FSharp.Collections.SetTreeModule.height = function(t) {
    return (function(thisObject) {
        if (t instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
            return 1;
        } else if (t instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
            var h = t.get_Item4();
            return h;
        } else {
            return 0;
    ...
    return function(k) {
        return function(t2) {
            ...
            return (function(thisObject) {
                ...
                } else if (t1h > (t2h + Pit.FSharp.Collections.SetTreeModule.get_tolerance)) {
                    return (function(thisObject) {
    ...
    return function(k) {
        return function(t) {
            return (function(thisObject) {
                ...
                } else if (t instanceof Pit.FSharp.Collections.SetTree1.SetEmpty) {
                    return new Pit.FSharp.Collections.SetTree1.SetOne(k);
                } else {
                    var r = t.get_Item3();
                    var l = t.get_Item2();
                ...
                return (function(thisObject) {
                    if (matchValue.Item1 instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                        return (function(thisObject) {
                            ...
                            } else if (matchValue.Item2 instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                    ...
                    } else if (matchValue.Item1 instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
                        return (function(thisObject) {
                            if (matchValue.Item2 instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                            ...
                            } else if (matchValue.Item2 instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
                                ...
                                return (function(thisObject) {
                                    ...
                                    } else if ((h2 + Pit.FSharp.Collections.SetTreeModule.get_tolerance) < h1) {
        ...
        return function(s) {
            return function(acc) {
                return (function(thisObject) {
                    ...
                    } else if (s instanceof Pit.FSharp.Collections.SetTree1.SetEmpty) {
                        return acc;
                    } else {
                        var r = s.get_Item3();
                        var l = s.get_Item2();
        ...
        return function(t2) {
            ...
            return (function(thisObject) {
                if (matchValue.Item1 instanceof Pit.FSharp.Collections.SetTree1.SetEmpty) {
                    ...
                    return t;
                } else if (matchValue.Item1 instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                    return (function(thisObject) {
                        if (matchValue.Item2 instanceof Pit.FSharp.Collections.SetTree1.SetEmpty) {
        ...
        if (stack instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
            return (function(thisObject) {
                if (stack.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                    return stack;
                } else if (stack.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
    ...
    return (function(thisObject) {
        if (i.get_started()) {
            ...
            return (function(thisObject) {
                ...
                } else if (matchValue.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
    ...
    return function(l1) {
        return function(l2) {
            ...
            return (function(thisObject) {
                            ...
                            return (function(thisObject) {
                                if (matchValue.Item2.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                                    return (function(thisObject) {
                                        ...
                                        } else if (matchValue.Item1.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
                                            return (function(thisObject) {
                                ...
                                } else if (matchValue.Item2.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetNode) {
                                    return (function(thisObject) {
                                        ...
                                        } else if (matchValue.Item1.get_Head() instanceof Pit.FSharp.Collections.SetTree1.SetOne) {
                                            var n1k = matchValue.Item1.get_Head().get_Item();
                                            var t1 = matchValue.Item1.get_Tail();
                ...
                } else if (matchValue.Item2 instanceof Pit.FSharp.Collections.FSharpList1.Cons) {
                    return -1;
                } else {
                    return 0;
                }
...
Pit.FSharp.Control.LazyExtensions.Lazy1 = (function() {
    function Lazy1(f) {
        var thisObject = this;
        thisObject.f = f;
        thisObject.isValueCreated = false;
...
Pit.FSharp.Core.Operators.RangeEnumerator = (function() {
    function RangeEnumerator(start, step, endto) {
        ...
        this.IEnumerator1 = __createIEnumerator1(this);
        var thisObject = this;
        thisObject.start = start;
        thisObject.step = step;
        thisObject.endto = endto;
        thisObject.curr = (thisObject.start - thisObject.step);
    }
        ...
        var ienumerator = (function() {
            ...
            IEnumerator.prototype.MoveNext = function() {
                ...
                return (function(thisObject) {
                    ...
                    } else if (thisObject.x.curr >= thisObject.x.endto) {
                        return true;
                    } else {
                        return false;
                    }
